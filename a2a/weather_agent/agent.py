...
root_agent = Agent(
    ...
    name="root_agent",
    description="A helpful assistant that can provide 7-day weather forecasts.",
    instruction="""Use English language.
                Answer user questions to the best of your knowledge.
                When asked about weather forecasts, use the `google_search` to provide a 7-day forecast for a specified location and date.
                Always ask for both location and date if they are not provided.
                Always provide a 7-day forecast, start from the date that user provided.
                """,
    tools=[google_search],
)
